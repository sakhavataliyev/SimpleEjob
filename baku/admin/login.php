      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../setting/islem.php" method="POST">
            ...
            <div>
            <button style="width: 100%; background-color: #73879C; color:white;" type="submit" name="admingiris" class="btn btn-default"> Giriş </button>
            ...
            if (isset($_GET['durum'])) {
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Ejob</h1>
                <p>©2020 Online job</p>
              </div>
            </div>
          </form>
