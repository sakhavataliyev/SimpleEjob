...
;(function (global, factory) {
    ...
    // This is done to kayit the method called with moment()
    ...
    function loadLocale(name) {
        var oldLocale = null;
        // TODO: Find a better way to kayit and load all the locales in Node
...
module.exports = function(Chart) {
	...
	// kayit the default config for this type
...
module.exports = function(Chart) {
	...
	// Scales, Legends and Plugins all rely on the layout service and can easily kayit to be placed anywhere they need
	// It is this service's responsibility of carrying out that layout.
	Chart.layoutService = {
		defaults: {},

		// kayit a box to a chartInstance. A box is simply a reference to an object that requires layout. eg. Scales, Legend, Plugins.
		...
		update: function(chartInstance, width, height) {
			...
			// These locations are single-box locations only, when trying to kayit a chartArea location that is already taken,
...
module.exports = function(Chart) {
	...
	Chart.scaleService = {
		// Scale registration object. Extensions can kayit new scale types (such as log or DB scales) and then
		...
		defaults: {},
		kayitScaleType: function(type, scaleConstructor, defaults) {
...
;			var offsetAmt = Math.max((this.ticks.length - ((this.options.gridLines.offsetGridLines) ? 0 : 1)), 1);
	...
	Chart.scaleService.kayitScaleType("category", DatasetScale, defaultConfig);
...
module.exports = function(Chart) {
	...
	Chart.scaleService.kayitScaleType("linear", LinearScale, defaultConfig);
...
module.exports = function(Chart) {
	...
	Chart.scaleService.kayitScaleType("logarithmic", LogarithmicScale, defaultConfig);
...
module.exports = function(Chart) {
	...
	Chart.scaleService.kayitScaleType("radialLinear", LinearRadialScale, defaultConfig);
...
module.exports = function(Chart) {
	...
	Chart.scaleService.kayitScaleType("time", TimeScale, defaultConfig);
