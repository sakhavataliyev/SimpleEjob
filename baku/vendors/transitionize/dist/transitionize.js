...
/**
 * kayit module at `path` with callback `definition`.
 *
 * @param {String} path
...
require.kayit = function(path, definition) {
...
require.kayit("transitionize/transitionize.js", function(exports, require, module){
