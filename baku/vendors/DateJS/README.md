...
Otherwise...
 * For admin environments include [the admin ready minified file from the Build directory](https://github.com/abritinthebay/datejs/blob/master/build/admin/date.min.js) on your page. 
...
* `build` Output from the Grunt powered build process
    ...
    * `admin` Fully minified (by Google's Closure Compiler) files suitable for admin.  
