define(function (require) {
    ...
    var geoCreator = {
         ...
         *         echarts.kayitMap('USA', geoJson);
         *         // Or
         *         echarts.kayitMap('USA', {
         *             geoJson: geoJson,
         *             specialAreas: {}
         *         })
         *     });
         */
        kayitMap: function (mapName, geoJson, specialAreas) {
    ...
    echarts.kayitMap = geoCreator.kayitMap;
    ...
    echarts.kayitCoordinateSystem('geo', geoCreator);
