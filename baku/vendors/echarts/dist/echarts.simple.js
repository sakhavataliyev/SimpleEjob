...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function createkayitEventWithLowercaseName(method) {
	    ...
	    MessageCenter.prototype.on = createkayitEventWithLowercaseName('on');
	    MessageCenter.prototype.off = createkayitEventWithLowercaseName('off');
	    MessageCenter.prototype.one = createkayitEventWithLowercaseName('one');
	     ...
	     * @method
	     */
	    echartsProto.on = createkayitEventWithLowercaseName('on');
	    echartsProto.off = createkayitEventWithLowercaseName('off');
	    echartsProto.one = createkayitEventWithLowercaseName('one');
	     ...
	     * kayit theme
	     */
	    echarts.kayitTheme = function (name, theme) {
	        themeStorage[name] = theme;
	    };

	    /**
	     * kayit option preprocessor
	     * @param {Function} preprocessorFunc
	     */
	    echarts.kayitPreprocessor = function (preprocessorFunc) {
	     ...
	     */
	    echarts.kayitProcessor = function (stage, processorFunc) {
	    ...
	    /**
	     * Usage:
	     * kayitAction('someAction', 'someEvent', function () { ... });
	     * kayitAction('someAction', function () { ... });
	     * kayitAction(
	     ...
	     */
	    echarts.kayitAction = function (actionInfo, eventName, action) {
	     ...
	     */
	    echarts.kayitCoordinateSystem = function (type, CoordinateSystem) {
	        CoordinateSystemManager.kayit(type, CoordinateSystem);
	    };

	    /**
	     * @param {*} layout
	     */
	    echarts.kayitLayout = function (layout) {
	     ...
	     */
	    echarts.kayitVisualCoding = function (stage, visualCodingFunc) {
	    ...
	    echarts.kayitVisualCoding('echarts', zrUtil.curry(
	        __webpack_require__(89), '', 'itemStyle'
	    ));
	    echarts.kayitPreprocessor(__webpack_require__(90));
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     * @param {boolean} [options.kayitWhenExtend]
	     * @public
	     */
	    clazz.enableClassManagement = function (entity, options) {
	        ...
	        entity.kayitClass = function (Clazz, componentType) {
	            if (componentType) {
	        ...
	        if (options.kayitWhenExtend) {
	            var originalExtend = entity.extend;
	            if (originalExtend) {
	                entity.extend = function (proto) {
	                    var ExtendedClass = originalExtend.call(this, proto);
	                    return entity.kayitClass(ExtendedClass, proto.type);
	                };
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    // Add capability of kayitClass, getClass, hasClass, kayitSubTypeDefaulter and so on.
	    clazzUtil.enableClassManagement(
	        ComponentModel, {kayitWhenExtend: true}
	    );
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    componentUtil.enableSubTypeDefaulter = function (entity) {
	        ...
	        entity.kayitSubTypeDefaulter = function (componentType, defaulter) {
	            componentType = parseClassType(componentType);
...
/***/ function(module, exports) {
	...
	'use strict';
	    ...
	    CoordinateSystemManager.kayit = function (type, coordinateSystemCreator) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    // Enable capability of kayitClass, getClass, hasClass, kayitSubTypeDefaulter and so on.
	    clazzUtil.enableClassManagement(Component, {kayitWhenExtend: true});
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    var kCSSColorTable = {
	        ...
	        'deepskyblue': [0,191,255,1], 'imgray': [105,105,105,1],
	        'imgrey': [105,105,105,1], 'dodgerblue': [30,144,255,1],
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    // Add capability of kayitClass, getClass, hasClass, kayitSubTypeDefaulter and so on.
	    clazzUtil.enableClassManagement(Chart, {kayitWhenExtend: true});
	 ...
	 */
	    ...
	    ZImage.prototype = {
	        ...
	        brush: function (ctx) {
	            ...
	            // FIXME Case create many img with src
	            if (!image && src) {
	                // Try get from global image cache
	                var cacheimgObj = globalImageCache.get(src);
	                if (!cacheimgObj) {
	                    // Create a new image
	                    image = new Image();
	                    image.onload = function () {
	                        image.onload = null;
	                        for (var i = 0; i < cacheimgObj.pending.length; i++) {
	                            cacheimgObj.pending[i].dirty();
	                        }
	                    };
	                    cacheimgObj = {
	                        image: image,
	                    ...
	                    image.src = src;
	                    globalImageCache.put(src, cacheimgObj);
	                    this._image = image;
	                    return;
	                }
	                else {
	                    image = cacheimgObj.image;
	                    this._image = image;
	                    // Image is not complete finish, add to pending list
	                    if (!image.width || !image.height) {
	                        cacheimgObj.pending.push(this);
	                        return;
	                    }
	                }
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Global defines
	    ...
	    zrender.kayitPainter = function (name, Ctor) {
	 ...
	 */
	    ...
	    Painter.prototype = {
	        ...
	        _pathToImage: function (id, path, width, height, dpr) {
	            ...
	            var imghape = __webpack_require__(59);
	            var imgShape = new imghape({
	                id: id,
	                style: {
	                    x: 0,
	                    y: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    function createListFromArray(data, seriesModel, ecModel) {
	        ...
	        var kayitedCoordSys = CoordinateSystem.get(coordSysName);
	        // FIXME
	        var result = creator && creator(data, seriesModel, ecModel);
	        var dimensions = result && result.dimensions;
	        if (!dimensions) {
	            // Get dimensions from kayited coordinate system
	            dimensions = (kayitedCoordSys && kayitedCoordSys.dimensions) || ['x', 'y'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    __webpack_require__(25).kayit('cartesian2d', Grid);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = function (axisName, BaseAxisModelClass, axisTypeDefaulter, extraDefaultOption) {
	        ...
	        ComponentModel.kayitSubTypeDefaulter(
	            axisName + 'Axis',
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.kayitLayout(zrUtil.curry(barLayoutGrid, 'bar'));
	    // Visual coding for legend
	    echarts.kayitVisualCoding('chart', function (ecModel) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = function (seriesType, actionInfos) {
	        zrUtil.each(actionInfos, function (actionInfo) {
	             ...
	             */
	            echarts.kayitAction(actionInfo, function (payload, ecModel) {
	                var selected = {};
	                ecModel.eachComponent(
