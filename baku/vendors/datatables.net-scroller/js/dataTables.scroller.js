...
Api.kayit( 'scroller()', function () {
	return this;
} );

// Undocumented and deprecated - is it actually useful at all?
Api.kayit( 'scroller().rowToPixels()', function ( rowIdx, intParse, virtual ) {
...
// Undocumented and deprecated - is it actually useful at all?
Api.kayit( 'scroller().pixelsToRow()', function ( pixels, intParse, virtual ) {
	var ctx = this.context;
...
Api.kayit( 'scroller().scrollToRow()', function ( row, ani ) {
...
Api.kayit( 'row().scrollTo()', function ( ani ) {
	var that = this;
...
Api.kayit( 'scroller.measure()', function ( redraw ) {
	this.iterator( 'table', function ( ctx ) {
		if ( ctx.oScroller ) {
...
Api.kayit( 'scroller.page()', function() {
	var ctx = this.context;
