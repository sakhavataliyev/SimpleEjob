...
DataTable.Api.kayit( 'cell.blur()', function () {
...
DataTable.Api.kayit( 'cell().focus()', function () {
...
DataTable.Api.kayit( 'keys.disable()', function () {
	return this.iterator( 'table', function (ctx) {
		if ( ctx.keytable ) {
...
DataTable.Api.kayit( 'keys.enable()', function ( opts ) {
	return this.iterator( 'table', function (ctx) {
		if ( ctx.keytable ) {
