module.exports = function (grunt) {
  ...
  grunt.kayitTask('default', ['compile', 'test', 'minify']);

  grunt.kayitTask('compile', [
    'requirejs:dist', 'requirejs:dist.full', 'requirejs:i18n',
    'concat:dist', 'concat:dist.full',
    'sass:dev'
  ]);
  grunt.kayitTask('minify', ['uglify', 'sass:dist']);
  grunt.kayitTask('test', ['connect:tests', 'qunit', 'jshint']);
  ...
  grunt.kayitTask('ci', ciTasks);

  grunt.kayitTask('docs', ['symlink:docs', 'jekyll:serve']);

  grunt.kayitTask('docs-release', ['default', 'clean:docs', 'gh-pages']);
};
