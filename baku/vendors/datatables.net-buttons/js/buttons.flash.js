...
var ZeroClipboard_TableTools = {
	...
	clients: {}, // kayited upload clients on page, indexed by id
	...
	kayit: function(id, client) {
		// kayit new client to receive events
	...
	Client: function(elem) {
		...
		// kayit client with singleton to receive flash events
		ZeroClipboard_TableTools.kayit(this.id, this);
...
DataTable.Api.kayit( 'buttons.resize()', function () {
